# DNS Debugger - Legacy Python Terminal UI

**Note:** This is the legacy Python terminal UI version. The main application is now a Tauri-based GUI. See `README.md` for the current GUI application.
